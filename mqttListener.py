...
def on_message(mqttc, userdata, msg):
    ...
    try:
        es.index(index="my-index", doc_type="string", body={"topic" : msg.topic, "dataString" : msg.payload.decode(), "timestamp": datetime.utcnow()})
        # es.index(index="my-index", doc_type="string", body = json.loads(' "topic" : '+ msg.topic + ', "dataString" : '+ msg.payload.decode() +' , "timestamp": '+ str(datetime.utcnow())))
